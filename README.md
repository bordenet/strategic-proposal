...
The validator scores strategic proposals on a **100-point scale** across four equally-weighted dimensions:
...
Proposals must be actionable—vague recommendations without implementation paths receive low scores regardless of strategic insight. For complete methodology details including detection patterns, adversarial robustness, and calibration notes, see **[docs/Scoring_Methods.md](./docs/Scoring_Methods.md)**.
