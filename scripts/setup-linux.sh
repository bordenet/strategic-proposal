#!/usr/bin/env bash
# architecture-decision-record - Linux Setup Script
...
Setup script for Linux (Ubuntu/Debian) - Installs all dependencies for architecture-decision-record
...
print_header "architecture-decision-record - Linux Setup"
...
echo "  3. Start server:    npm run serve"
echo ""
