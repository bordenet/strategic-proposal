#!/usr/bin/env bash
# {{PROJECT_NAME}} - Windows WSL Setup Script
...
Setup script for Windows WSL (Ubuntu) - Installs all dependencies for {{PROJECT_NAME}}
...
print_header "{{PROJECT_NAME}} - Windows WSL Setup"
...
echo ""
echo "WSL Tips:"
echo "  - Access files from Windows: \\\\wsl$\\Ubuntu\\home\\<user>\\{{PROJECT_NAME}}"
